...
## В БД есть, в архивных индексах нет
...
| Хроносфера | http://localhost/glossary?term=xronosfera |

## Слишком короткие определения (< 20 символов)

Нет.

## Термины с привязанной страницей (page_id)
