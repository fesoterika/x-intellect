...
class MediaWikiArchive
{
    ...
    public array $skipTitles = [
        ...
        // Слита с /about/istoriya-proekta (редирект стоит вручную): без скипа
        // импорт воскрешает страницу, и редирект перекрывает её же адрес.
        'история создания',
        // Решение пользователя 16.07.2026: индексные страницы MediaWiki, страницы
        // поддержки/реквизитов и контактные — на новый сайт не переносим.
        'примеры диаграмм', 'правила википедии ср',
        'финансовая поддержка', 'финансовые реквизиты', 'творческие группы',
        'контакты', 'обратная связь', 'личные консультации', 'запись на личные консультации',
    ];
    ...
    public array $skipContains = [
        ...
        'различия между', 'просмотр исходного',
    ];
