...
class ContentFixes2026 extends Command
{
    ...
    protected const SESSIONS_2013_ITEMS = [
        // Цели — сами стенограммы: проектные страницы стояли заглушками, пока
        // вики-стенограммы не восстановились из Wayback (18.07.2026).
        '20130721' => [
            'seans-s-silami-20130721',
