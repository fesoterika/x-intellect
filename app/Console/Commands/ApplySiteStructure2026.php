...
class ApplySiteStructure2026 extends Command
{
    ...
    public function handle(): int
    {
        ...
        // 4а. В блоке «Сеансы» видны только страницы-указатели из списка выше.
        // В вики остались их ранние варианты («Сеансы 1991», «Сеансы 2007»,
        // «Сеансы 1997 - 2008»…) — тот же перечень за другой период. Они не
        // удаляются (адреса живые, на них ведут ссылки), но из списков скрыты.
        ...
        $this->info('Ранних вариантов указателей сеансов (скрыты из списков): '.$variants->count().'.');
